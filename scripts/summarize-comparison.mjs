...
const left = 100, width = 550, top = 112
let chart = `<svg xmlns="http://www.w3.org/2000/svg" width="800" height="555" viewBox="0 0 800 555" role="img" aria-labelledby="title desc"><title id="title">StreamMD versus Streamdown</title><desc id="desc">Median total seconds, lower is better. Each size uses its own zero-based scale. ${measurements.map(row=>`${row.kib} KiB: StreamMD ${row.values[0].toFixed(2)}, Streamdown ${row.values[1].toFixed(2)} seconds.`).join(' ')}</desc><rect width="800" height="555" fill="white"/><g font-family="system-ui, sans-serif" font-size="13" fill="#24292f"><text x="24" y="28" font-size="18" font-weight="600">StreamMD vs Streamdown</text><text x="24" y="50">Median total seconds · lower is better · mixed content</text><text x="24" y="72" fill="#57606a">Each size has its own scale. Compare bars within each panel.</text>`
